...
initial_announcements = [
    {
        "id": "spring-activities-registration",
        "title": "Spring activity registration is open",
        "message": "Registration stays open through May 31. Review the updated club schedules and reserve student spots early.",
        "start_date": None,
